...
UPDATE WRK.WRK_TELP WRKTEL
SET PART_ID = (SELECT PART_ID FROM WRK.WRK_RPART WRKPAT WHERE WRKTEL.INDIVIDU_ID = WRKPAT.INDIVIDU_ID AND 'Patient' = WRKPAT.FONCTION_INDIVIDU AND 'Patient' = WRKTEL.FONCTION_INDIVIDU)
