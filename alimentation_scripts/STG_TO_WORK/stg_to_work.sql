...
SELECT CONCAT(ID_PERSONNEL, 'Patient') AS PART_ID, ID_PATIENT, 'Patient' AS FONCTION_INDIVIDU, 
...
SELECT CONCAT(ID_PERSONNEL, 'Patient') AS PART_ID, ID_PATIENT, 'Patient' AS FONCTION_INDIVIDU, NUM_VOIE, DSC_VOIE, COMPL_VOIE, CD_POSTAL, VILLE, 
...
SELECT CONCAT(ID_PERSONNEL, 'Patient') AS PART_ID, ID_PATIENT, 'Patient' AS FONCTION_INDIVIDU FROM STG.PATIENT;
